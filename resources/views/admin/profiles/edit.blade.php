                ...
                <form action="{{ route('admin.profiles.update', $profile) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('school_name') is-invalid @enderror" 
                                   id="school_name" name="school_name" value="{{ old('school_name', $profile->school_name) }}" required>
                            @error('school_name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('principal_name') is-invalid @enderror" 
                                   id="principal_name" name="principal_name" value="{{ old('principal_name', $profile->principal_name) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('welcome_message') is-invalid @enderror" 
                                  id="welcome_message" name="welcome_message" rows="3" required>{{ old('welcome_message', $profile->welcome_message) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('principal_message') is-invalid @enderror" 
                                  id="principal_message" name="principal_message" rows="3">{{ old('principal_message', $profile->principal_message) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        @if($profile->principal_photo)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $profile->principal_photo) }}" alt="Foto Kepala Sekolah" class="img-thumbnail" style="max-width: 150px;">
                            </div>
                        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('mission') is-invalid @enderror" 
                                      id="mission" name="mission" rows="3">{{ old('mission', $profile->mission) }}</textarea>
                            @error('mission')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
